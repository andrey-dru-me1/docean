...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        11 => wire__crate__api__storage__DocumentRepository_feedback_stats_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        12 => wire__crate__api__storage__DocumentRepository_get_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        13 => wire__crate__api__storage__DocumentRepository_get_content_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        15 => wire__crate__api__storage__DocumentRepository_list_paths_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        18 => wire__crate__api__storage__DocumentRepository_paths_of_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        19 => wire__crate__api__storage__DocumentRepository_prune_suggestions_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        20 => wire__crate__api__storage__DocumentRepository_put_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        21 => wire__crate__api__storage__DocumentRepository_put_content_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        22 => wire__crate__api__storage__DocumentRepository_put_path_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        23 => wire__crate__api__storage__DocumentRepository_put_suggestion_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        24 => wire__crate__api__storage__DocumentRepository_put_tag_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        25 => wire__crate__api__storage__DocumentRepository_query_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        26 => wire__crate__api__storage__DocumentRepository_read_bytes_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        27 => wire__crate__api__storage__DocumentRepository_record_feedback_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        30 => wire__crate__api__storage__DocumentRepository_unassign_path_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        31 => wire__crate__api__storage__DocumentRepository_update_title_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        33 => wire__crate__api__ai__ai_classify_impl(port, ptr, rust_vec_len, data_len),
        34 => wire__crate__api__ai__ai_embed_impl(port, ptr, rust_vec_len, data_len),
        35 => wire__crate__api__ai__ai_generate_impl(port, ptr, rust_vec_len, data_len),
        41 => wire__crate__api__assistant__assistant_ask_impl(port, ptr, rust_vec_len, data_len),
        42 => wire__crate__api__assistant__assistant_ask_stream_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        46 => wire__crate__api__auto_org__auto_org_apply_suggestion_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        47 => wire__crate__api__auto_org__auto_org_confirm_current_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        50 => wire__crate__api__auto_org__auto_org_dismiss_suggestion_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        51 => wire__crate__api__auto_org__auto_org_generate_filename_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        52 => wire__crate__api__auto_org__auto_org_list_suggestions_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        53 => wire__crate__api__auto_org__auto_org_organize_impl(port, ptr, rust_vec_len, data_len),
        56 => wire__crate__api__auto_org__auto_org_reorganize_selected_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        57 => wire__crate__api__auto_org__auto_org_reset_learning_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        32 => wire__crate__api__ai__ai_active_provider_impl(ptr, rust_vec_len, data_len),
        36 => wire__crate__api__ai__ai_list_providers_impl(ptr, rust_vec_len, data_len),
        37 => wire__crate__api__ai__ai_remove_api_key_impl(ptr, rust_vec_len, data_len),
        38 => wire__crate__api__ai__ai_save_provider_settings_impl(ptr, rust_vec_len, data_len),
        39 => wire__crate__api__ai__ai_select_provider_impl(ptr, rust_vec_len, data_len),
        40 => wire__crate__api__ai__ai_set_api_key_impl(ptr, rust_vec_len, data_len),
        43 => {
        ...
        48 => wire__crate__api__auto_org__auto_org_default_config_impl(ptr, rust_vec_len, data_len),
